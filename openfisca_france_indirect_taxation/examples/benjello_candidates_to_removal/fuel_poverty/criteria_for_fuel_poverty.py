...
log.info("Sur l'ensemble des ménages :")
log.info(" ")
log.info((100 * sum(data_enl['pondmen'] * (data_enl['froid'] == 1)) / sum(data_enl['pondmen'])))
log.info(" ")
log.info("Par décile de niveau de vie :")
log.info(" ")
for i in range(1, 11):
    data_enl_decile = data_enl.query('niveau_vie_decile == {}'.format(i))
    log.info(i, "-", 100 * sum(data_enl_decile['pondmen'] * (data_enl_decile['froid'] == 1)) / sum(data_enl_decile['pondmen']))
...
log.info("Sur l'ensemble des ménages :")
log.info(" ")
log.info((100 * sum(data_enl['pondmen'] * (data_enl['froid_cout'] == 1)) / sum(data_enl['pondmen'])))
log.info(" ")
log.info("Par décile de niveau de vie :")
log.info(" ")
for i in range(1, 11):
    data_enl_decile = data_enl.query('niveau_vie_decile == {}'.format(i))
    log.info((i, "-", 100 * sum(data_enl_decile['pondmen'] * (data_enl_decile['froid_cout'] == 1)) / sum(data_enl_decile['pondmen'])))
...
log.info("Sur l'ensemble des ménages :")
log.info(" ")
log.info((100 * sum(data_matched_random['pondmen'] * (data_matched_random['aise_froid'] == 1)) / sum(data_matched_random['pondmen'])))
log.info(" ")
log.info("Par décile de niveau de vie :")
log.info(" ")
for i in range(1, 11):
    data_matched_random_decile = data_matched_random.query('niveau_vie_decile == {}'.format(i))
    log.info((i, "-", 100 * sum(data_matched_random_decile['pondmen'] * (data_matched_random_decile['aise_froid'] == 1)) / sum(data_matched_random_decile['pondmen'])))
...
log.info("Sur l'ensemble des ménages :")
log.info(" ")
log.info((100 * sum(data_matched_random['pondmen'] * (data_matched_random['aise_froid_cout'] == 1)) / sum(data_matched_random['pondmen'])))
log.info(" ")
log.info("Par décile de niveau de vie :")
log.info(" ")
for i in range(1, 11):
...
log.info("Sur l'ensemble des ménages :")
log.info(" ")
log.info((100 * float(sum(data_matched_random['part_energies_revtot'] > 0.15)) / len(data_matched_random)))
log.info(" ")
log.info("Par décile de niveau de vie :")
log.info(" ")
for i in range(1, 11):
...
log.info("Sur l'ensemble des ménages :")
log.info(" ")
log.info((100 * float(sum(data_matched_random['part_energies_revtot'] > 0.1)) / len(data_matched_random)))
log.info(" ")
log.info("Par décile de niveau de vie :")
log.info(" ")
for i in range(1, 11):
...
log.info("Sur l'ensemble des ménages :")
log.info(" ")
log.info((100 * float(sum(data_matched_random['part_energies_depenses_tot'] > 0.15)) / len(data_matched_random)))
log.info(" ")
log.info("Par décile de niveau de vie :")
log.info(" ")
for i in range(1, 11):
...
log.info("Sur l'ensemble des ménages :")
log.info(" ")
log.info((100 * float(sum(data_matched_random['part_energies_depenses_tot'] > 0.1)) / len(data_matched_random)))
log.info(" ")
log.info("Par décile de niveau de vie :")
log.info(" ")
for i in range(1, 11):
