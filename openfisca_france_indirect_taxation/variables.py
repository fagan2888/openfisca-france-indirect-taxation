...
class YearlyVariable(Variable):
    def __init__(self, baseline_variable = None):
        ...
        try:
            ...
            log.info(("deleting class baseline_variable for {}".format(self.__class__.__name__)))
        ...
        try:
            ...
            log.info(("deleting instance baseline_variable for {}".format(self.__class__.__name__)))
